...
func CreateTableStmt(tableName string, sch schema.Schema, foreignKeys []*doltdb.ForeignKey) string {
...
func CreateTableStmtWithTags(tableName string, sch schema.Schema, foreignKeys []*doltdb.ForeignKey) string {
	return createTableStmt(tableName, sch, func(col schema.Column) string {
...
func createTableStmt(tableName string, sch schema.Schema, fmtCol fmtColFunc, foreignKeys []*doltdb.ForeignKey) string {
